...
function ViewerInner() {
  ...
  return (
    <main className="min-h-screen bg-mc-bg text-mc-text flex flex-col">
      <div className="p-2 border-b border-mc-border bg-mc-bg-secondary flex items-center justify-between">
        <button
        ...
        <div className="text-xs text-mc-text-secondary truncate max-w-[70vw]">{path}</div>
      </div>
      <iframe
        title="preview"
